...
export const metadata = { title: 'Users Analytics — Admin' }
...
export default function AdminUsersAnalyticsPage() {
  return (
    <div>
      <AdminPageHeader title="Users Analytics" breadcrumbs={[{label:'Admin',href:'/admin'},{label:'Analytics',href:'/admin/analytics'},{label:'Users'}]}/>
      ...
      <AdminCard title="Users — 7 Day Trend">
