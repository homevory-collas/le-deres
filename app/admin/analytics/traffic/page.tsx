...
export default function AdminTrafficAnalyticsPage() {
  return (
    <div>
      <AdminPageHeader title="Traffic Analytics" breadcrumbs={[{label:'Admin',href:'/admin'},{label:'Analytics',href:'/admin/analytics'},{label:'Traffic'}]}/>
      ...
      <AdminCard title="Traffic — 7 Day Trend">
