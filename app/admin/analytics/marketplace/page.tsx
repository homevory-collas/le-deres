...
export const metadata = { title: 'Marketplace Analytics — Admin' }
...
export default function AdminMarketplaceAnalyticsPage() {
  return (
    <div>
      <AdminPageHeader title="Marketplace Analytics" breadcrumbs={[{label:'Admin',href:'/admin'},{label:'Analytics',href:'/admin/analytics'},{label:'Marketplace'}]}/>
      ...
      <AdminCard title="Marketplace — 7 Day Trend">
